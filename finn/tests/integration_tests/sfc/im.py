...
class test_sfc(unittest.TestCase):
    def test_sfc(self):
        ...
        for phase_shift in np.arange(phase_min, phase_max, phase_step):
            ...
            conn_value_fd = self.calc_from_time_domain(signal_1, signal_2, frequency_sampling, nperseg, nfft, frequency_target)
            conn_value_coh = self.calc_from_time_domain(signal_1, signal_2, frequency_sampling, nperseg, nfft, frequency_target)
    ...
    def calc_from_time_domain(self, signal_1, signal_2, frequency_sampling, nperseg, nfft, frequency_target):
        return sfc_td.run_ic(signal_1, signal_2, frequency_sampling, nperseg, nfft)[1][frequency_target]
    ...
    def calc_from_frequency_domain(self, signal_1, signal_2, frequency_sampling, nperseg, nfft, frequency_target):
        ...
        return sfc_fd.run_ic(fd_signal_1, fd_signal_2)[1][[np.argmin(np.abs(bins - frequency_target))]]
    ...
    def calc_from_coherency_domain(self, signal_1, signal_2, frequency_sampling, nperseg, nfft, frequency_target):
        ...
        return sfc_cohd.run_ic(coh)[np.argmin(np.abs(bins - frequency_target))]
