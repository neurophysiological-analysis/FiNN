...
def run(data_1, data_2, bins, fmin, fmax, return_signed_conn = True, minimal_angle_thresh = 2):
    """
    ...
    return calc.run(coh, bins, fmin, fmax, return_signed_conn, minimal_angle_thresh)
