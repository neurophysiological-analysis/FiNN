...
class test_pac(unittest.TestCase):
    ...
    def test_pac(self):
        ...
        dmi_score = cfc.dmi(low_freq_signal, high_freq_signal, phase_window_half_size = 4, phase_step_width = 2)[0]
        plv_score = cfc.plv(low_freq_signal, high_freq_signal)
        mvl_score = cfc.mvl(low_freq_signal, high_freq_signal)
        mi_score = cfc.mi(low_freq_signal, high_freq_signal)
